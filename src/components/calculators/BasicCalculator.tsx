    ...
    if (currentOperation && storedValue !== null) {
      try {
        const result = evaluate(
          `${storedValue} ${currentOperation} ${display}`
        );
    ...
    <Card className="w-full max-w-md mx-auto" data-aos="zoom-in">
      <CardHeader>
        ...
        <CardDescription className="text-center font-supreme ">
          Basic calculators for quick arithmetic and <br /> daily number
          crunching
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-4 gap-2">
          <Button variant="outline" size="calc" onClick={handleClear}>
            {clearAll ? 'AC' : 'C'}
          </Button>
          <Button variant="outline" size="calc" onClick={handlePlusMinus}>
            +/-
          </Button>
          <Button variant="outline" size="calc" onClick={handlePercent}>
            %
          </Button>
          <Button
            variant="calculator"
          ...
          <Button variant="outline" size="calc" onClick={handleDecimal}>
            .
          </Button>
          <Button
            variant="calculator"
