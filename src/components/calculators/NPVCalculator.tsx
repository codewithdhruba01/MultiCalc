...
export default function NPVCalculator() {
  ...
  return (
    <Card className="w-full max-w-md mx-auto" data-aos="zoom-in">
      <CardHeader>
        <CardTitle className="text-center font-synonym font-bold mb-3">NPV Calculator</CardTitle>
      ...
      <CardContent>
        <div className="space-y-4">
          <div>
            <label htmlFor="initialInvestment" className="block text-sm font-medium mb-2">
              Initial Investment
            </label>
            <Input
          ...
          <div>
            <label htmlFor="cashFlows" className="block text-sm font-medium mb-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button onClick={calculateNPV} disabled={!initialInvestment || !cashFlows || !discountRate}>
              Calculate
            </Button>
          ...
          {npv !== null && (
            <div className="mt-6 p-4 bg-muted rounded-md">
              <h3 className="text-xl font-bold mb-2 text-center font-synonym">NPV Result</h3>
              <p className="text-center text-2xl font-bold">{npv} currency units</p>
          ...
          <div className="text-xs text-muted-foreground text-center mt-4">
            ...
            <p className="mt-1 font-satoshi">Note: This tool assumes consistent time periods and cash flow intervals.</p>
          </div>
        </div>
      </CardContent>
    </Card>
