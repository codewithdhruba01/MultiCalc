      ...
      <Container>
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-center mb-8 font-satoshi">
            Calculate your exact age in years, months, days, hours, minutes, and
            seconds
          </p>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div
                  className={liveUpdate ? 'opacity-50 pointer-events-none' : ''}
                >
                  <label
                    htmlFor="toDate"
                    className="block text-sm font-medium mb-1"
                ...
                <CardContent>
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-6">
                      From {formatDate(birthDate)}{' '}
                      {liveUpdate ? 'to now' : `to ${formatDate(toDate)}`}
                    </p>
                  </div>
                </CardContent>
              </Card>
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          <strong>{getDaysUntilNextBirthday()} days</strong> on
                          a <strong>{getNextBirthdayWeekday()}</strong>.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          {Math.floor(age.totalDays / 7).toLocaleString()}{' '}
                          weeks.
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          ...
                          {Math.floor(age.totalMinutes * 80).toLocaleString()}{' '}
                          times (assuming average 80 beats per minute).
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <HeartPulse className="text-red-600 w-5 h-5 flex-shrink-0" />
                        <span>
                          You have taken approximately{' '}
                          {Math.floor(age.totalMinutes * 16).toLocaleString()}{' '}
                          breaths (assuming average 16 breaths per minute).
                        </span>
                      </li>
                      {age.years >= 8 && (
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            You have slept for approximately{' '}
                            {Math.floor(age.totalHours / 3).toLocaleString()}{' '}
                            hours (assuming 8 hours of sleep per day).
                          </span>
                        </li>
                      )}
                    </ul>
